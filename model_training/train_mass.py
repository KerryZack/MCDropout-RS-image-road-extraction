...
parser.add_argument('--resume', type=str,
                    default='../logs/MassChu/ts_t_drop_cls/DLinkNet34/S_20240317_235948.081965_False/best.pth.tar', help='checkpoint path')
...
parser.add_argument(
        '--model-name',type=str,default='DLinkNet34',help='network name. \
...
#     t_model = UNet(num_classes=args.num_classes, n_init_features=3, drop_rate=args.dropout_rate)
    # t_model = models.segmentation.fcn_resnet50(num_classes = args.num_classes, pretrained=False)
    # t_model = models.segmentation.fcn_resnet50(num_classes = 2, pretrained=False,drop_rate=0.5)
#     t_model = UNetWithResnet50Encoder(n_classes=args.num_classes,drop_rate= args.dropout_rate)
    ...
    s_model = models.segmentation.fcn_resnet50(num_classes = 2, pretrained=False ,drop_rate=0.5)
