...
def main():
    ...
    parser.add_argument('--model-file', type=str, default="../logs/MassChu/ts_t_drop_cls/DLinkNet34/S_20240413_174509.050329_True/best.pth.tar",
    ...
    parser.add_argument(
        '--save-dir',
        type=str,
        default='../logs/MassChu/ts_t_drop_cls/DLinkNet34/S_20240413_174509.050329_True/results',
