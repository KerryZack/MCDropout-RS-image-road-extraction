...
from model.models import U_Net,SegNet
otherargs=args
...
def main():
    ...
    parser.add_argument('--model-file', type=str, default="../logs/DeepGlobe/ts_t_drop_cls/DeepLabV3Plus/S_20240322_092929.981446_False/best.pth.tar",
    ...
    parser.add_argument(
        '--save-dir',
        type=str,
        default='../logs/DeepGlobe/ts_t_drop_cls/DeepLabV3Plus/S_20240322_092929.981446_False/results',
...
#     model = DLinkNet34(num_classes=args.num_classes, drop_rate=args.dropout_rate)\
